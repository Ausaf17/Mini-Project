...
const Login = () => {
  ...
  const LoginForm = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      if (res.status === 200)
        window.location.replace('/add-properties')
      {
  ...
  return (
    <div className='max-w-xl mx-auto '>
      ...
      <div className="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-neutral-900 dark:border-neutral-500">
